...
class ReplyCommentLikeController implements RequestHandlerInterface
{
    /**
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $existingReaction = WikiReplyCommentLike::where('comment_id', $commentId)->where('user_id', $actor->id)->first();
